...
//         <img src={bigShoeImg} alt="shoe collection" width={590} height={480} className="object-contain relative z-10" />
//         <div className="flex sm:gap-6 gap-4 absolute -bottom-[10%] sm:left-[10%] max-sm:px-6">
//           {shoes.map((image, index) => (
//             <div key={index}>
//               <ShoeCard 
//               imgURL={image} changeBigShoeImage={(shoe) => setBigShoeImg(shoe)} bigShoeImage={bigShoeImg}
//               />
//             </div>
//           ))}
//         </div>
